...
import { useSubscriptionsQuery, useAssignSubscriptionMutation } from '../hooks/useSubscriptions';
import { usePlansQuery } from '../../plans/hooks/usePlans';
import { TenantSubscription } from '../api/subscriptions.api';
...
export default function SubscriptionsContent() {
  ...
  // Derived filtered list — reactively recomputed whenever data or any filter changes.
  // No useState/useEffect needed; useMemo eliminates the extra render cycle.
          ...
          <View style={{ marginHorizontal: 16, marginVertical: 12, backgroundColor: cardBg, borderRadius: 16, borderWidth: 1, borderColor: borderCol, padding: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 3, elevation: 1 }}>
            ...
            <View style={{ gap: 10 }}>
              ...
              <View style={{ flexDirection: 'row', gap: 10, marginTop: 4 }}>
                <TouchableOpacity
                  onPress={() => { /* filtering is reactive — results update automatically */ }}
